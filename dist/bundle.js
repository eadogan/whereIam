...
var mapTemplate = document.getElementById('map').innerHTML;
function searchAddressHandler(event) {
    event.preventDefault();
    var address = addressInput.value;
    //send this to API
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("https://api.mapbox.com/geocoding/v5/mapbox.places/'" + address + "'.json?access_token=pk.eyJ1IjoiYXZmOTM2MTEiLCJhIjoiY2tuaGl0Z2k2Mnp3bTJxdGExand1d28xdCJ9.Kwo_E0OOh1e5AR5M3tUq_A").then(function (response) {
